...
https://www.techtravelhub.com/how-to-implement-cmmi-in-agile/

https://docs.microsoft.com/en-us/azure/devops/boards/work-items/guidance/cmmi-process?view=azure-devops
...
- Processes are well characterized and understood, are described in standard, procedures, tools, and methods
- The organizations set of standard processes, is established and improved over time.
- Establishing consistency across the organization.
- Process areas
	...
	- Product integration to assemble the product from product components, ensure that the product as integrated, functions properly and deliver the product.
	- Verification to ensure that selected work products meet their specified requirements.
	- Validation to demonstrate that a product and product component fulfills its intended use.
	...
	- Organization process focus to plan, implement, and deploy organizational process improvements based on a thorough understanding of the current strengths and weakness of the organization's processes and process assets.
	...
	- Risk management, to identify potential problems before they occur so that risk-handling activities can be pre-planned.
...
- Quantitative objective based on:
	...
	- Organization
	- Process implements
- Detailed measures of process performance is analyzed.
- Process area
	- Organizational process performance, to maintain an understanding of the performance of the organization;s set of standard process and to provide performance data, 'baselines, and models in order to qualitatively manage the organization's projects/
	- Quantitative project management, to manage the project's defined process to achieve the project's established quality and performance objective.

### Maturity Level 5
- Focus on improving performance through incremental and innovative technological improvements.
- Both processes are the organization's set of measurable improvement activities.
- Process area
	- Organizational innovation and deployment to select and deploy incremental and innovative improvements that measurably improve the organization's processes and technologies. The improvements support the organization's quality and process-performance objective as derived from the organization's business objective.
	- Casual analysis and resolution, to identify causes of defects and other problems and take action to prevent them from occurring in the future.

## Appraisal
Examination of one or more processes by professionals using an appraisal reference model as the basis for determining strengths and weaknesses.

It consider three categories of model components
...
SCAMPI just like an accreditation.
![](attachments/Pasted%20image%2020211110162204.png)

## Conclusion
- CMMI efficiently and effectively improve and assess multibple disciplines across organization.
...
- Use of integrated model to guide enterprise process improvement promises to be one of the more sustainable and profitable initiatives that any organization might pursue.
- Use a SCAMPI to guide the implementation, measure the progress, and verify the achievements.
